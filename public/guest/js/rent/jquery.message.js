(function ($) {
    ...
    MessageConstructor.prototype.init = function (options) {
        ...
        if (this.type.toLowerCase() != 'warning') {
            msg += '<img class="jq-message__img" src="' + typeImg + '">';
        }
           msg += '<div class="jq-message__group">' + this.message + '</div>' +
            closeBtn + '</div>';
        $('body').append(msg);
        this.$element = $('#' + msgId);
